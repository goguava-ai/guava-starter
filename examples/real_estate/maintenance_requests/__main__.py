...
class MaintenanceRequestController(guava.CallController):
    ...
    def save_results(self):
        urgency = (self.get_field("urgency_level") or "").lower()
        ...
        results = {
            ...
            "fields": {
                "tenant_name": self.get_field("tenant_name"),
                "unit_address": self.get_field("unit_address"),
                ...
                "best_entry_time": self.get_field("best_entry_time"),
                "permission_to_enter": self.get_field("permission_to_enter"),
                "contact_phone": self.get_field("contact_phone"),
            },
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=MaintenanceRequestController,
    )
