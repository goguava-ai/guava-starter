...
agent = guava.Agent(
    ...
    purpose="to help customers report issues and open support cases with Brightpath Support",
)
...
@agent.on_task_complete("open_case")
def on_done(call: guava.Call) -> None:
    ...
    severity = call.get_field("severity") or "medium"
