...
agent = guava.Agent(
    ...
    purpose="to help customers add information to an existing open support case with Brightpath Support",
)
...
def on_done(call: guava.Call) -> None:
    ...
    case_id = (call.get_field("case_id") or "").strip()
    ...
    conv_attrs = conversation.get("attributes", {})
