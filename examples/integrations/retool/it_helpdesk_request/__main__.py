...
@agent.on_task_complete("submit_ticket")
def on_done(call: guava.Call) -> None:
    name = call.get_field("employee_name") or "Unknown Employee"
    email = call.get_field("employee_email") or ""
    department = call.get_field("department") or ""
    category = call.get_field("issue_category") or "other"
    description = call.get_field("issue_description") or ""
    urgency = call.get_field("urgency") or "normal — affecting my work"
