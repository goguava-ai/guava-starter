...
@agent.on_task_complete("trigger_workflow_and_respond")
def on_done(call: guava.Call) -> None:
    name = call.get_field("caller_name") or "the caller"
    request_type = call.get_field("request_type") or "other"
    detail = call.get_field("request_detail") or ""
    priority = call.get_field("priority") or "routine"
