...
class PrescriptionRefillController(guava.CallController):
    ...
    def handle_complete(self):
        ...
        medication = self.get_field("medication_name") or "medication"
        pharmacy = self.get_field("pharmacy_name") or "patient's preferred pharmacy"
        pharmacy_phone = self.get_field("pharmacy_phone") or ""
        has_changed_medications = self.get_field("has_changed_medications") or "no"
