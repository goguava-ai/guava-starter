...
def on_handle_complete(call: guava.Call) -> None:
    ...
    cell_phone = call.get_field("cell_phone") or ""
    insurance_carrier = call.get_field("insurance_carrier") or ""
    insurance_member_id = call.get_field("insurance_member_id") or ""
    primary_care_concern = call.get_field("primary_care_concern") or ""
