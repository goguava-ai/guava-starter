...
@agent.on_task_complete("log_conversation")
def on_done(call: guava.Call) -> None:
    name = call.get_field("caller_name") or "Unknown"
    email = call.get_field("caller_email") or ""
    issue_type = call.get_field("issue_type") or "general inquiry"
    detail = call.get_field("issue_detail") or ""
    response_pref = call.get_field("preferred_response") or "email"
