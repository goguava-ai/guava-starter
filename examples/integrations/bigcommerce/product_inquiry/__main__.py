...
agent = guava.Agent(
    ...
    purpose="to help Harbor House customers find the right products and get answers about availability, pricing, and product details",
)
...
@agent.on_task_complete("collect_product_inquiry")
def on_collect_done(call: guava.Call) -> None:
    product_name = call.get_field("product_name")
