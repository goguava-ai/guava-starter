...
class BillingInquiryController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.handle_billing_inquiry,
        )

        self.accept_call()

    def handle_billing_inquiry(self):
        email = (self.get_field("caller_email") or "").strip().lower()
        inquiry = self.get_field("inquiry_type") or "other billing question"
