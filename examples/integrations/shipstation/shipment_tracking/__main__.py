...
class ShipmentTrackingController(guava.CallController):
    def __init__(self):
        ...
        self.set_persona(
            ...
            agent_name="Jordan",
            agent_purpose="to help Coastal Supply Co. customers track and manage their shipments",
        )
        ...
        self.set_task(
            ...
            on_complete=self.lookup_shipment,
        )

        self.accept_call()

    def lookup_shipment(self):
    ...
    def handle_followup(self):
        choice = self.get_field("anything_else") or "nothing else"
