...
class AccountVerificationController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.verify_account,
        )

        self.accept_call()

    def verify_account(self):
        name = self.get_field("account_holder_name") or ""
        reference = self.get_field("account_reference") or ""
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=AccountVerificationController,
    )
