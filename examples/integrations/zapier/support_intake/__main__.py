...
class SupportIntakeController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.fire_support_zap,
        )

        self.accept_call()

    def fire_support_zap(self):
        ...
        impact = self.get_field("impact_level") or "minor issue, workaround exists"
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=SupportIntakeController,
    )
