...
class ERAPaymentLookupController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.retrieve_era,
        )

        self.accept_call()

    def retrieve_era(self):
        transaction_id = (self.get_field("transaction_id") or "").strip()
