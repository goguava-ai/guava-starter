...
class OrderLookupController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_persona(
            ...
            agent_name="Morgan",
            agent_purpose="to help Apex Store customers look up their orders by phone",
        )
...
if __name__ == "__main__":
    guava.Client().listen_inbound(
        ...
        controller_class=OrderLookupController,
    )
