...
agent = guava.Agent(
    ...
    purpose="to help Apex Store engineers and on-call staff quickly query application logs by phone",
)
...
@agent.on_task_complete("log_inquiry")
def on_done(call: guava.Call) -> None:
    service_name = call.get_field("service_name") or ""
    log_level = call.get_field("log_level") or "all"
    time_window = call.get_field("time_window") or "1 hour"
