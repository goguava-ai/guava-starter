...
class ReturnLabelRequestController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.register_return,
        )
    ...
    def register_return(self):
        ...
        order_id = self.get_field("order_id") or "unknown"
        return_tracking = (self.get_field("return_tracking_number") or "").strip()
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=ReturnLabelRequestController,
    )
