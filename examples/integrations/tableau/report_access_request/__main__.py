...
class ReportAccessRequestController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.submit_access_request,
        )

        self.accept_call()

    def submit_access_request(self):
        caller_name = self.get_field("caller_name") or "Unknown"
        caller_email = self.get_field("caller_email") or ""
        workbook_name = self.get_field("workbook_name") or ""
        access_reason = self.get_field("access_reason") or ""
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=ReportAccessRequestController,
    )
