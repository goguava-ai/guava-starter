...
agent = guava.Agent(
    ...
    purpose="to help Kestrel Goods customers cancel their orders",
)
...
@agent.on_task_complete("cancel_order")
def on_done(call: guava.Call) -> None:
    email = call.get_field("email") or ""
    order_number = call.get_field("order_number") or ""
    cancel_reason = call.get_field("cancel_reason") or "customer"
    confirm = call.get_field("confirm_cancel") or "no"
