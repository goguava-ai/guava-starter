...
class ReturnRequestController(guava.CallController):
    def __init__(self):
        ...
        self.set_persona(
            ...
            agent_name="Casey",
            agent_purpose="to help Kestrel Goods customers initiate product returns",
        )
        ...
        self.set_task(
            ...
            on_complete=self.create_return,
        )
    ...
    def create_return(self):
        ...
        return_reason = self.get_field("return_reason") or "other"
        item_description = self.get_field("item_description") or ""
