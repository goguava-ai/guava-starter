...
agent = guava.Agent(
    ...
    purpose=f"to help {BUSINESS_NAME} customers schedule appointments",
)
...
def on_done(call: guava.Call) -> None:
    ...
    service = call.get_field("service_type") or "other"
    date_str = call.get_field("preferred_date") or ""
    time_str = call.get_field("preferred_time") or "flexible"
    notes = call.get_field("special_notes") or ""
