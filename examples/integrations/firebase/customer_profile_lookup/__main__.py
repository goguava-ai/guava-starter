...
class CustomerProfileLookupController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.look_up_and_assist,
        )

        self.accept_call()

    def look_up_and_assist(self):
        method = self.get_field("lookup_method") or "email address"
        value = (self.get_field("lookup_value") or "").strip()
        inquiry = self.get_field("inquiry_reason") or ""
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=CustomerProfileLookupController,
    )
