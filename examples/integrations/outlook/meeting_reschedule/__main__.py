...
@agent.on_task_complete("find_and_reschedule")
def on_done(call: guava.Call) -> None:
    meeting_name = call.get_field("meeting_name") or ""
    new_date = call.get_field("new_date") or ""
    new_start = call.get_field("new_start_time") or ""
    new_end = call.get_field("new_end_time") or ""
    ...
    event = events[0]
    event_id = event["id"]
    old_summary = format_event_summary(event)
