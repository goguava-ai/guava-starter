...
class PriorAuthorizationCheckController(guava.CallController):
    def __init__(self):
        super().__init__()
    ...
    def check_auth(self):
        ...
        auth_number = (self.get_field("auth_number") or "").strip()
        procedure_code = (self.get_field("procedure_code") or "").strip()
        procedure_desc = self.get_field("procedure_description") or ""
...
if __name__ == "__main__":
    guava.Client().listen_inbound(
        ...
        controller_class=PriorAuthorizationCheckController,
    )
