...
class TaskCreationController(guava.CallController):
    def __init__(self):
        super().__init__()
        ...
        self.set_task(
            ...
            on_complete=self.create_task,
        )

        self.accept_call()

    def create_task(self):
        title = self.get_field("task_title") or ""
        description = self.get_field("task_description") or ""
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=TaskCreationController,
    )
