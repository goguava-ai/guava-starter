...
class RefundRequestController(guava.CallController):
    def __init__(self):
        ...
        self.set_persona(
            ...
            agent_name="Maya",
            agent_purpose="to help patients process refund requests",
        )
    ...
    def handle_complete(self):
        transaction_id = self.get_field("transaction_id")
        last_four = self.get_field("last_four")
        confirm = self.get_field("confirm_refund")
