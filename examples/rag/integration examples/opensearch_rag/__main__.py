...
class OpenSearchPolicyQAController(guava.CallController):
    """Answers policy questions using OpenSearch neural hybrid search and Gemini generation."""
...
if __name__ == "__main__":
    ...
    guava.Client().listen_inbound(
        ...
        controller_class=OpenSearchPolicyQAController,
    )
