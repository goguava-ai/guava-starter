...
class DamagedGoodsClaimController(guava.CallController):
    def __init__(self):
        super().__init__()

        self.set_persona(
            organization_name="SwiftShip Logistics - Claims",
            agent_name="Morgan",
            agent_purpose=(
    ...
    def save_results(self):
        results = {
            ...
            "delivery_date": self.get_field("delivery_date"),
            "damage_description": self.get_field("damage_description"),
            "number_of_damaged_items": self.get_field("number_of_damaged_items"),
            "packaging_condition": self.get_field("packaging_condition"),
            "photos_available": self.get_field("photos_available"),
            "replacement_or_refund_preference": self.get_field("replacement_or_refund_preference"),
...
if __name__ == "__main__":
    guava.Client().listen_inbound(
        ...
        controller_class=DamagedGoodsClaimController,
    )
